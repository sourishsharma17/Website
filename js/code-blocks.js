/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+python&plugins=line-numbers+autolinker+command-line+toolbar+copy-to-clipboard+match-braces */
...
(function () {
	...
	Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
		...
		linkSpan.classList.add("far");
		linkSpan.classList.add("fa-copy");
		...
		function resetText() {
			setTimeout(function () { linkSpan.classList.remove("fas"); }, settings['copy-timeout']);
		}

		/** @param {"copy" | "copy-error" | "copy-success"} state */
		function setState(state) {
			if (state = "copy-success") {
				linkSpan.classList.add("fas");
			} else {
